...
const Navbar = () => {
  ...
  return (
    ...
    <div id="sticky-wrapper" className="sticky-wrapper is-sticky bg-gray-500" style={{height: '100.667px'}}>

     <header className ="site-navbar js-sticky-header site-navbar-target container_top_progress_bar bg-gray-500" role="banner" style={{ position: 'fixed', top: 0, zIndex: 'inherit', width: '100%'}}>
                        ...
                        <ul className="site-menu js-clone-nav m-0 d-none d-lg-block">
                            ...
                            <li className='has-children'>
                                ...
                                <ul className="dropdown arrow-top">
                                     ...
                                     {categories.map(
                                        e => <li key={e.id}><a href={`${e.id}/ProjetByCategory`}>{e.name}</a></li>
                                    )} 
                                </ul>
                            </li>
                        ...
                        <div className="nav-bar ml-auto">
                         ...
                         {/* <div className="profile nav-bar flex items-center gap-2 cursor-pointer pt-0 ml-auto mr-5" onClick={() => handleClick()}>
                            <img className="rounded w-10 h-10" src={user} alt="user-image" />
                             <div className="rounded-full w-10 h-10 bg-orange-600 text-center text-white mt-1">
                                <h6 className="text-center mt-2">R</h6>
                             </div> 
