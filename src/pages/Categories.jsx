            ...
            <div className="col-12">
                <div className="category-list-item">
                    ...
                    <div className="category-list-action">
                        <span className="category-projet"> <a href='/Projet' >{data.projets} projets</a> </span>
                ...
                <div className="category-grid-item card" >
                    ...
                    <div className="category-grid-item-bottom">
                       <div className="ch_card_body">
                         <a href={`${data.id}/Projet`} className="btn border-dark ch_btn">Explorer</a>
                       </div>
                        <div className="category-projet">
                         <span className="mx-2"> <a href="/Projet">{data.projets} Projets</a> </span>
                        </div>
                    </div>
                </div>
            </div> 
